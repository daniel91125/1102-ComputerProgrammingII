...
void HugeInteger< T >::operator-=(HugeInteger< T >& op2)
{
	...
	//for (int i = 0; i < difference.integer.size() - 1; ++i)
	//{
	//	difference.integer[i] += 10;
	//	if (i != 0)
	//		difference.integer[i]--;
	//}
	//
	...
	for (int i = difference.integer.size() - 1; i >= 0; i--)
	{
		if (difference.integer[i] != 0)
			break;
		else if (difference.integer[i] == 0)
...
void HugeInteger< T >::operator*=(HugeInteger< T >& op2)
{
	...
	for (int i = 0; i < op2.integer.size(); ++i)
	{
		...
		{
			product.integer[i + j] += op2.integer[i] * integer[j];
	...
	for (int i = product.integer.size() - 1; i >= 0; i--)
	{
		if (product.integer[i] != 0)
			break;
		else if (product.integer[i] == 0)
